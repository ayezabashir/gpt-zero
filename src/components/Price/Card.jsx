...
const Card = ({ pic, title, heading, para, color }) => {
    return (
        <div className="p-8 rounded-md shadow-lg bg-white hover:shadow-xl lg:max-w-[30%] flex flex-col justify-between cursor-pointer hover:scale-105 ease-out delay-150 duration-300">
