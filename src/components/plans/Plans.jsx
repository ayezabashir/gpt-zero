...
const Plans = () => {
    return (
        <>
            <div className="">
                <h2 className="text-txt-black text-2xl text-center mt-10 my-5 font-bold">Choose Your Plan</h2>
                <div className="container flex justify-center gap-3">
                    <button className="text-txt-black font-medium" >Yearly <span className="text-blue">(Save 33%)</span> </button>
                    <button className="text-gray font-medium">Monthly</button>
                </div>
